...
static const ei_color_t gray  = { 0x33, 0x33, 0x33, 0xFF };
static const ei_color_t white = { 0xD0, 0xD0, 0xD0, 0xFF };
static const ei_color_t black  = { 0x30, 0x30, 0x30, 0xFF };
static const ei_color_t	light_gray = { 0x45, 0x45, 0x45, 0xFF };
